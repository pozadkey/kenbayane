...
class FooterIconItems extends StatefulWidget {
  String title;
  IconData footerIcon;
  Color initialColor;
  Color hoverColorIn;
  ...
  @override
  _FooterIconItemsState createState() => _FooterIconItemsState();
}

class _FooterIconItemsState extends State<FooterIconItems> {
  @override
